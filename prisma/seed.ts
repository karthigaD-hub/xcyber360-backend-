...
async function main() {
  ...
  // Create Admin (one-time via seed — can also use POST /auth/admin-register)
  ...
  // Create sample Customer (with password for login)
  ...
  // Create Consolidation provider + sample providers
